...
class Trader():
        ...
        def get_historical_prices(self, stock, span):
                ...
                data = helper.request_get(url,dataType='results',payload=payload)
                #https://www.youtube.com/watch?v=kgarr-1vvIM
                # request_get is returning an invalid request, something with authentication. Needs looking into.
